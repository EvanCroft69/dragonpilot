...
class DRIVER_MONITOR_SETTINGS():
  def __init__(self, DT_DMON=DT_DMON):
    ...
    self._AWARENESS_TIME = 9999999999999999999999999999999999999999999999999999999999999999999999999999999999. # passive wheeltouch total timeout
    self._AWARENESS_PRE_TIME_TILL_TERMINAL = 0.
    self._AWARENESS_PROMPT_TIME_TILL_TERMINAL = 0.
    self._DISTRACTED_TIME = 9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999. # active monitoring total timeout
